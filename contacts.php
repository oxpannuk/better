...
<div class="contacts-container">
    ...
    <ul class="contact-list">
        <li><i class="fas fa-envelope" style="color:var(--primary-color); margin-right:10px;"></i>Email: <a href="mailto:support@better.local" style="color:var(--primary-color);">support@better.local</a></li>
        <li><i class="fas fa-phone" style="color:var(--primary-color); margin-right:10px;"></i>Телефон: +7 800 303 35  (пн-пт, 9:00-18:00)</li>
        <li><i class="fas fa-map-marker-alt" style="color:var(--primary-color); margin-right:10px;"></i>Адрес: г. Омск, ул. Гагарина, 10 </li>
    </ul>
    ...
    <h2>Мы в соцсетях</h2>
    <p style="color:var(--text-color); margin-bottom: 20px;">Присоединяйтесь к нам в социальных сетях, чтобы быть в курсе новостей, обновлений платформы и полезных советов по улучшению офисной жизни. Подписывайтесь, комментируйте и делитесь идеями!</p>
    ...
    <div style="border-radius: 8px; overflow: hidden;">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2294.567890123!2d73.3773804!3d54.9873657!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x43aafe0d0f0f0f0f%3A0x0!2zNTTCsDU5JzE0LjUiTiA3M8KwMjInMzguNiJF!5e0!3m2!1sru!2sru!4v1700000000" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
