...
// Простая обработка формы (без реальной отправки email)
...
<div style="max-width:600px; margin:0 auto; background:var(--card-bg); padding:30px; border-radius:12px; box-shadow:var(--shadow);">
    ...
    <?php if (isset($success) && $success): ?>
        <div style="text-align:center; padding:20px;">
            ...
            <p style="color:var(--text-color); margin-bottom:10px;">Спасибо, <strong><?= $name ?></strong>! Ваше сообщение успешно отправлено.</p>
            <p style="color:var(--secondary-color); margin-bottom:25px;">Мы ответим вам на email: <strong><?= $email ?></strong> в ближайшее время.</p>
            
            <div style="margin-top:30px;">
                <a href="contacts.php" style="background:var(--primary-color); color:white; padding:12px 24px; border-radius:8px; text-decoration:none; margin-right:10px;">
                    <i class="fas fa-arrow-left"></i> Вернуться к контактам
                </a>
                <a href="index.php" style="background:var(--secondary-color); color:white; padding:12px 24px; border-radius:8px; text-decoration:none;">
    ...
    <?php elseif (isset($errors) && !empty($errors)): ?>
        <div style="text-align:center; padding:20px;">
            ...
            <div style="background:var(--card-bg); border:1px solid var(--danger-color); border-radius:8px; padding:15px; margin-bottom:25px;">
            ...
            <a href="contacts.php" style="background:var(--primary-color); color:white; padding:12px 24px; border-radius:8px; text-decoration:none;">
