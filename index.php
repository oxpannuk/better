    ...
    <form method="POST">
        <div
            ...
            <select name="city_id" id="city-select" required
                style="padding:12px; border:1px solid var(--border-color); border-radius:8px; background:var(--card-bg); color:var(--text-color);">
        ...
        <div style="display: flex; gap: 15px; flex-wrap: wrap;">
            <form method="GET" style="display: flex; gap: 10px; align-items: center;">
                <select name="city" onchange="this.form.submit()"
                    style="padding:10px; border:1px solid var(--border-color); border-radius:6px; min-width:150px; background:var(--card-bg); color:var(--text-color);">
                ...
                <select name="company" onchange="this.form.submit()"
                    style="padding:10px; border:1px solid var(--border-color); border-radius:6px; min-width:180px; background:var(--card-bg); color:var(--text-color);">
                ...
                <select name="type" onchange="this.form.submit()"
                    style="padding:10px; border:1px solid var(--border-color); border-radius:6px; min-width:160px; background:var(--card-bg); color:var(--text-color);">
                ...
                <!-- поля для сохранения других параметров -->
        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            ...
            <form method="GET" style="display: flex; gap: 10px;">
                <select name="sort" onchange="this.form.submit()"
                    style="padding:10px; border:1px solid var(--border-color); border-radius:6px; background:var(--card-bg); color:var(--text-color); min-width:180px;">
...
function loadReplies(id) {
    ...
    // Если ответы уже показаны, скрывает их
    if (repliesDiv.style.display === 'block') {
    ...
    fetch(`api.php?action=get_replies&parent_id=${id}`)
        ...
        .then(data => {
            ...
            if (data && data.length > 0) {
                data.forEach(reply => {
                    ...
                    // проверка может ли пользователь редактировать/удалять этот ответ
        ...
        .catch(error => {
            ...
            repliesDiv.innerHTML =
                '<div style="color: var(--danger-color); padding: 10px; text-align: center;">Ошибка загрузки ответов: ' +
                error
                .message + '</div>';
        });
}
